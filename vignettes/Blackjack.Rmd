...
This package includes a custom vector class for cards using the `vctrs` package. You can create a card vector and extract information like suit or value:
...
For a detailed explanation of internal design decisions, C++ and vctrs integration, and future considerations, please refer to the [Design Vignette](design-choices.html).
