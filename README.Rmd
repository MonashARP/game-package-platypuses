...
You can also explore function documentation without attaching the full package by using `?Blackjack::function_name`. For example:
...
For more details and examples, see the vignette or visit the package website [Blackjack](https://monasharp.github.io/game-package-platypuses/) on the **Get Started** page !
